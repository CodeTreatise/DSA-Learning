...
│  2. PROCESS CURRENT                                  │
│     - Mark visited                                  │
│     - Do computation (count, collect, etc.)         │
├─────────────────────────────────────────────────────┤
...
│     - Or return status (found/not found)            │
└─────────────────────────────────────────────────────┘
```
...
## 💻 Template 1: Basic DFS (Graph Traversal)
...
## 💻 Template 2: Boolean DFS (Path Exists)
...
## 💻 Template 3: Accumulator DFS (Collect Results)
...
## 💻 Template 5: Backtracking DFS (All Solutions)
...
## 💻 Template 6: DFS with Path Tracking
...
## 💻 Template 7: Three-State DFS (Cycle Detection)
...
| Grid | O(rows * cols) | O(rows * cols) | Grid size |
...
```python
# ❌ Wrong: Check visited after processing
def dfs(node):
...
```python
# ⚠️ Be careful: Sometimes you WANT to modify
...
> **💡 Key Insight:** DFS templates differ mainly in: (1) what you return, (2) whether you backtrack, and (3) what state you track. Master the basic template, then learn the variations.

> **🔗 Related:** [DFS Fundamentals](./4.1-DFS-Fundamentals.md) | [DFS Applications](./4.3-DFS-Applications.md) | [Backtracking](../../02-Recursion-Backtracking/02-Backtracking/2.2-Backtracking-Template.md)

---

**Previous:** [← 4.1 DFS Fundamentals](./4.1-DFS-Fundamentals.md)  
**Next:** [4.3 DFS Applications →](./4.3-DFS-Applications.md)
