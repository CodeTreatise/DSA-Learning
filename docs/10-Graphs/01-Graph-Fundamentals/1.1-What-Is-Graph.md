...
>
> ⏱️ **Time:** 20-30 min | 📊 **Difficulty:** Beginner | 🎯 **Interview Frequency:** Foundation
...
```
    ...
    │     │  \          |         │          (B,D), (C,D)
    │     │   \         |         │
    │    [C] ──────── [D]         │   5 vertices would need
    │                             │   at most 10 edges (complete)
    └─────────────────────────────┘
```
...
- **Adjacency Matrix:** Must allocate V*V matrix regardless of edge count
...
# ✅ Correct: Add both directions for undirected
graph[u].append(v)
graph[v].append(u)
```
...
```python
# ❌ Wrong: Assuming all vertices reachable from start
...
```python
# ❌ Wrong: Vertex with no edges won't exist in adjacency list
graph = defaultdict(list)
# If vertex 'X' has no edges, graph['X'] won't show it exists

# ✅ Correct: Explicitly track all vertices
vertices = set()
...
|---------|------------|---------|
| [Find the Town Judge](https://leetcode.com/problems/find-the-town-judge/) | 🟢 Easy | Degree calculation |
| [Find Center of Star Graph](https://leetcode.com/problems/find-center-of-star-graph/) | 🟢 Easy | Graph structure |

### After BFS/DFS
| Problem | Difficulty | Purpose |
|---------|------------|---------|
| [Number of Islands](https://leetcode.com/problems/number-of-islands/) | 🟡 Medium | Connected components |
| [Clone Graph](https://leetcode.com/problems/clone-graph/) | 🟡 Medium | Graph traversal |
...
> **💡 Key Insight:** A graph is the most general way to represent relationships. Every tree, linked list, and even array can be viewed as a special case of a graph with specific constraints.

> **🔗 Related:** [Graph Terminology](./1.2-Graph-Terminology.md) | [Types of Graphs](./1.3-Types-Of-Graphs.md) | [Graph Representation](../02-Graph-Representation/2.1-Adjacency-Matrix.md)

---

**Next:** [1.2 Graph Terminology →](./1.2-Graph-Terminology.md)
