...
> **Interview Value:** ⭐⭐⭐⭐⭐ - Very common patterns  
...
**The insight:**
```
Before sorting: Random order → Need O(n²) to find pairs
After sorting: Ordered → Two pointers O(n) or Binary Search O(log n)
```
...
## ✅ When to Use Sort-First Approach
...
- [Heap Basics](../.../08-Heaps-Priority-Queues/08-Heaps-Priority-Queues.md)
...
## Problem 2: Merge Intervals (LC 56) ⭐⭐⭐
...
## Problem 4: Sort Colors (LC 75) - Dutch National Flag ⭐⭐⭐
...
## Problem 5: Largest Number (LC 179) ⭐⭐⭐
...
## Problem 6: Kth Largest Element (LC 215) ⭐⭐⭐
