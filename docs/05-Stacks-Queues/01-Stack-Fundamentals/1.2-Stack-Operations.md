...
stack.append(30)      # Stack: [10, 20, 30] ← TOP
```
...
> **💡 Key Insight:** Stack operations are simple but the patterns they create are powerful. Master the basic operations, then focus on recognizing when to apply common patterns like "pop while condition" or "peek before decide."
