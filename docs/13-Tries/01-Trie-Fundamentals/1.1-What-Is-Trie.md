...
- [Hash Maps](../.../09-Hashing/09-Hashing.md) - Children often stored as hash maps
- [Recursion/DFS](../.../02-Recursion-Backtracking/02-Recursion-Backtracking.md) - Trie traversal uses DFS
...
| **Build Trie** | O(n * m) | O(n * m) | n words, avg length m |
...
Space = O(ALPHABET_SIZE * m * n) worst case
      = O(26 * avg_length * num_words) for lowercase
...
- [ ] [Implement Trie](https://leetcode.com/problems/implement-trie-prefix-tree/) - LC 208 ⭐ Start here
...
- [ ] [Word Search II](https://leetcode.com/problems/word-search-ii/) - LC 212 ⭐ Classic
...
|---------|-----------|-----------------|
| **Uber** | ⭐⭐⭐⭐ | Autocomplete, word search |
| **Airbnb** | ⭐⭐⭐⭐ | Search suggestions |
| **Dropbox** | ⭐⭐⭐ | File path matching |
| **Google** | ⭐⭐ | Less common, but appears |
| **Amazon** | ⭐⭐ | Occasionally in design |
...
> **💡 Key Insight:** A Trie trades space for time on prefix operations. Every path from root represents a prefix shared by all words below it. This sharing is what makes Tries efficient for dictionaries with common prefixes.

> **🔗 Related:** [TrieNode Structure](./2.1-TrieNode-Structure.md) | [Insert Operation](../02-Trie-Operations/3.1-Insert-Operation.md) | [Trie + Backtracking](../03-Trie-Patterns/4.2-Trie-Plus-Backtracking.md)
