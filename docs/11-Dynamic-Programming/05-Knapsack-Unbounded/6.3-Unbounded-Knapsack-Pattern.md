...
## 💻 Core Template: Unbounded Knapsack
...
| Permutations | Amount outer, coins inner | [1,2] ≠ [2,1] |
...
| Coin Change II (count) | O(n*amount) | O(amount) |
| Rod Cutting | O(n²) | O(n) |
...
- **Day 30:** Mixed—identify 0/1 vs unbounded instantly
...
> "Outer loop over coins gives combinations—[1,2] and [2,1] are the same. If I wanted permutations, I'd swap the loops."
...
> **💡 Key Insight:** The ONLY difference from 0/1 Knapsack is iteration direction. Forward = unbounded (same item reusable). Backward = 0/1 (each item once). Remember: "Forward for Infinite, Backward for Bounded."

> **🔗 Related:** [0/1 Knapsack](../04-Knapsack-01/) | [Coin Change Practice](./6.3-Unbounded-Knapsack.md/) | [DP Fundamentals](../01-DP-Fundamentals/)
