...
├────────────────────────────────────────────────────────────┤
│ Sequence/Array?                                            │
│   ├─ One sequence → Fibonacci/Linear DP                    │
...
├────────────────────────────────────────────────────────────┤
│ Range/interval optimization?                               │
│   └─ Merge/split ranges → Interval DP                      │
├────────────────────────────────────────────────────────────┤
│ Tree structure?                                            │
│   └─ Tree-based → Tree DP                                  │
├────────────────────────────────────────────────────────────┤
...
> - Choice 1: [description] → dp[...] + [contribution]
> - Choice 2: [description] → dp[...] + [contribution]
...
**❌ Wrong:** "I know this pattern, let me code..."
**✅ Right:** "Let me define the state clearly and verify with an example first."

### 2. Unclear State Definition

**❌ Wrong:** "dp[i] is like... the answer somehow"
**✅ Right:** "dp[i] represents the maximum profit using the first i items with capacity w"
...
**❌ Wrong:** Optimizing before getting the 2D solution right
**✅ Right:** Get 2D working, then optimize to 1D if asked
...
> **💡 Key Insight:** DP is about breaking down problems into overlapping subproblems. The hardest part is defining the right state. Once you have that, the recurrence often becomes clear.

> **🔗 Related:** [DP Fundamentals](../01-DP-Fundamentals/1.1-What-Is-DP.md) | [Problem-Solving Framework](../01-DP-Fundamentals/3.0-DP-Problem-Solving-Framework.md) | [When to Use DP](../01-DP-Fundamentals/1.2-When-To-Use-DP.md)
