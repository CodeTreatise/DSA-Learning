...
- [Hash Maps](#) - for tracking elements in window

**After mastering this:**
- [Monotonic Queue](../.../05-Stacks-Queues/05-Stacks-Queues.md) - for sliding window maximum
- [Deque](../.../05-Stacks-Queues/05-Stacks-Queues.md) - efficient add/remove from both ends
