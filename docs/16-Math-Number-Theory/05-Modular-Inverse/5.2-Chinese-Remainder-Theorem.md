...
def chinese_remainder_theorem(remainders: list[int], moduli: list[int]) -> int:
    ...
    Time: O(k * log max_mod) where k is number of equations
    Space: O(1)
    """
...
```python
# ❌ WRONG - negative intermediate result
...
| Scenario | Use CRT? |
|----------|----------|
| Multiple remainder conditions | ✅ |
| Coprime moduli | ✅ |
| Need unique solution mod M | ✅ |
| Reconstruct from hash values | ✅ |
...
> **💡 Key Insight:** CRT transforms a complex "find x satisfying all conditions" problem into simple modular arithmetic. The magic is that coprime moduli guarantee a unique solution, and we can construct it systematically using modular inverses.

> **🔗 Related:** [Modular Inverse](./5.1-Modular-Inverse-Basics.md) | [Extended GCD](../02-GCD-LCM/2.2-Extended-GCD.md) | [LCM/GCD](../02-GCD-LCM/2.1-Euclidean-Algorithm.md)
