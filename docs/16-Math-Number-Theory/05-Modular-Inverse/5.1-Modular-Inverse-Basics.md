...
```python
# ❌ WRONG - assumes inverse always exists
def divide(a, b, m):
...
```python
# ❌ WRONG - Fermat requires prime m
pow(a, m - 2, m)  # Only works if m is prime!

# ✅ CORRECT - use Extended GCD for non-prime
...
| [Unique Paths](https://leetcode.com/problems/unique-paths/) | 🟡 Medium | nCr with inverse |
| [Count Good Numbers](https://leetcode.com/problems/count-good-numbers/) | 🟡 Medium | Modular exponentiation |
...
> **💡 Key Insight:** The modular inverse transforms division into multiplication. For prime m, use a^(m-2). For any m (when gcd = 1), use Extended GCD. This unlocks all fraction operations in modular arithmetic.

> **🔗 Related:** [Chinese Remainder Theorem →](./5.2-Chinese-Remainder-Theorem.md) | [Extended GCD](../02-GCD-LCM/2.2-Extended-GCD.md) | [Fast Power](../01-Fundamentals/1.3-Fast-Power.md)
