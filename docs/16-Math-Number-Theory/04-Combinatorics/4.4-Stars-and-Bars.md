...
flowchart TD
    ...
    B -->|"Identical items → distinct bins"| C["Stars and Bars"]
    B -->|"Distinct items → distinct bins"| D["n^k or k^n"]
    B -->|"Distinct items → identical bins"| E["Partition numbers"]
...
- "Non-negative integer solutions to x₁ + x₂ + ... = n"
...
Represent n balls as ★ and k-1 dividers as |.
...
**Counting:** Arrange n ★s and k-1 |s.
...
# (1,1,3), (1,2,2), (1,3,1), (2,1,2), (2,2,1), (3,1,1) = 6 ✓
```
...
**Question:** How many ways to make $n using coins of values c₁, c₂, ..., cₖ?
...
## 📖 Problem: Count Sorted Vowel Strings (LC 1641)
...
## 📖 With Constraints (Bounded Stars and Bars)
...
| x₁ + ... + xₖ = n | xᵢ ≥ mᵢ | Substitute yᵢ = xᵢ - mᵢ |
...
```python
# ❌ WRONG - distinct items need different formula
...
|---------|------------|---------------|
| [Count Sorted Vowel Strings](https://leetcode.com/problems/count-sorted-vowel-strings/) | 🟡 Medium | Multiset formula |
| [Combination Sum IV](https://leetcode.com/problems/combination-sum-iv/) | 🟡 Medium | DP (order matters) |
| [Coin Change 2](https://leetcode.com/problems/coin-change-ii/) | 🟡 Medium | DP (specific values) |
...
> **💡 Key Insight:** Stars and Bars transforms a "sum equals n" problem into a "choose positions" problem. The n items are stars, the k-1 dividers are bars, and we choose where to place the bars.

> **🔗 Related:** [← Catalan Numbers](./4.3-Catalan-Numbers.md) | [nCr Basics](./4.1-nCr-Basics.md) | [Modular Arithmetic](../01-Fundamentals/1.2-Modular-Arithmetic.md)
