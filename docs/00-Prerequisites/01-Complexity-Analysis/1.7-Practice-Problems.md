...
>
> ⏱️ *Estimated time: 45-60 minutes for all problems*
...
2. **Write your answer first** — Before checking
3. **Explain your reasoning** — Practice articulating WHY
4. **Check the solution** — Understand any mistakes
...
- O(100) = O(1) — constants are dropped
...
- To reach n, we need log₂(n) doublings
- Example: n=16 → i goes 1, 2, 4, 8, 16 → 4 iterations = log₂(16)
...
**Explanation:**
- Outer loop: n iterations
- Inner loop: j doubles each time → log n iterations
...
**Explanation:**
- Outer loop: i halves each time → log n iterations
...
- Calls: mystery15(n) → mystery15(n-1) → ... → mystery15(0)
...
- Calls: mystery17(n) → mystery17(n/2) → mystery17(n/4) → ... → mystery17(1)
- Total: log₂(n) calls, O(1) work each = O(log n)
...
- Master Theorem: a=2, b=2, d=1 → a = b^d → Case 2
...
| Score | Level |
|-------|-------|
| 0-5 | Review basics — re-read 1.1 and 1.2 |
| 6-10 | Getting there — focus on loop patterns |
| 11-15 | Good understanding — practice more recursion |
| 16-20 | Strong foundation — ready for interviews |
| 21-23 | Excellent! — you've mastered complexity analysis |
...
> **💡 Key Insight:** Complexity analysis is a skill that improves with practice. Every time you write or read code, ask yourself: "What's the complexity?" Make it a habit, and it will become second nature.

---

**Congratulations!** You've completed the Complexity Analysis module. 

**Return to:** [00-Prerequisites.md](../.../00-Prerequisites/00-Prerequisites.md) | **Next Unit:** [01-Arrays-Strings](../../01-Arrays-Strings/01-Arrays-Strings.md)
