...
## 📐 Application 1: Missing Number (LC 268)
...
## 📐 Application 2: Swap Without Temp Variable
...
```python
# ❌ DANGEROUS - fails when a and b reference same memory!
arr = [1, 2, 3]
...
## 📐 Application 3: Hamming Distance (LC 461)
...
## 📐 Application 4: Total Hamming Distance (LC 477)
...
## 📐 Application 5: Find the Duplicate Number
...
## 📐 Application 6: Bitwise AND of Range (LC 201)
...
```python
# ❌ WRONG - starts at 0, misses case when 0 is missing
result = 0
for i, num in enumerate(nums):
    result ^= i ^ num
# If n=3, we never XOR with 3!

# ✅ CORRECT - start with n
...
| Total Hamming Distance | 🟡 Medium | Bit counting | [LC #477](https://leetcode.com/problems/total-hamming-distance/) |
| Bitwise AND of Range | 🟡 Medium | Common prefix | [LC #201](https://leetcode.com/problems/bitwise-and-of-numbers-range/) |
...
> **💡 Key Insight:** XOR with expected values reveals missing/extra elements. This pattern extends to many "find the difference" problems.

> **🔗 Related:** [XOR Properties ←](./3.1-XOR-Properties.md) | [Single Number Variants ←](./3.2-Single-Number-Variants.md) | [Essential Tricks →](../02-Bit-Tricks/2.1-Essential-Tricks.md)
