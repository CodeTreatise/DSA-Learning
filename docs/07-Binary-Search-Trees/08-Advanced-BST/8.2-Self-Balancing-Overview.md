...
## ✅ When to Use Self-Balancing BST
...
```python
# ❌ Wrong: Writing 200+ lines of AVL code in interview
class AVLTree:
    def insert(self, val):
        # ... complex rotation logic ...
        pass

# ✅ Correct: Use built-in balanced structures
...
```python
# ❌ Wrong: Using ordered structure for unordered access
from sortedcontainers import SortedDict
sd = SortedDict()  # O(log n) operations

# ✅ Correct: Hash table when order doesn't matter
d = {}  # O(1) operations
```
...
# ✅ Correct: Use balanced BST for ordered operations
from sortedcontainers import SortedDict
sd = SortedDict()
