...
def numTrees(self, n: int) -> int:
    ...
    Pattern: G(n) = Σ G(i-1) * G(n-i) (Catalan numbers)
    """
...
```python
# ❌ Wrong: Missing G[0] base case
G[0] = 0  # Empty tree should count as 1 structure!

# ✅ Correct: Empty tree is a valid structure
G[0] = 1
G[1] = 1
```
...
|---------|-----------|-------|
| Amazon | ⭐⭐⭐ | Medium frequency |
| Google | ⭐⭐⭐ | May ask DP insights |
| Meta | ⭐⭐ | Less common |
