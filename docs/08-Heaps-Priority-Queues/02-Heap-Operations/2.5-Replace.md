...
# ❌ Wrong: heapreplace on empty heap raises IndexError
heap = []
heapq.heapreplace(heap, 5)  # IndexError!

# ✅ Correct: Check or use heappush for empty
if not heap:
...
# ❌ Wrong: Replacing when heap isn't full yet
...
# ✅ Correct: Build heap to size K first
...
# ⚠️ Subtle: This works but might miss elements
...
|---------|-----------|-------|
| All | ⭐⭐⭐⭐ | Core for Top K |
| Amazon | ⭐⭐⭐⭐ | Many streaming problems |
| Meta | ⭐⭐⭐⭐ | Performance-focused |
| Google | ⭐⭐⭐ | May ask about optimization |
