...
> **Interview Value:** ⭐⭐⭐⭐⭐ - Required for Trees, Graphs, DP, Backtracking  
...
> **💡 Key Insight:** Every recursive problem has two parts:
...
factorial(4) calls:
┌─────────────────────────────┐
│  factorial(1) → returns 1   │  ← Top (evaluates first)
├─────────────────────────────┤
│  factorial(2) → 2 × 1 = 2   │
├─────────────────────────────┤
│  factorial(3) → 3 × 2 = 6   │
├─────────────────────────────┤
│  factorial(4) → 4 × 6 = 24  │  ← Bottom (started here)
└─────────────────────────────┘
```
...
- Each call adds a stack frame → O(depth of recursion)
