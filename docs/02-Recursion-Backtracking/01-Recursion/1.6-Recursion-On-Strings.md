...
> **Interview Value:** ⭐⭐⭐⭐ - Palindromes, reversals, string generation  
...
## 📐 Common String Recursion Problems
...
## 💻 Code: Practical Interview Examples
...
❌ **Wrong:** O(n²) due to repeated concatenation
```python
...
**Common follow-ups:**
- "What if string has duplicates?" → Skip duplicate characters in permutations
- "Can you do it iteratively?" → Yes, using a stack
...
> **Strings are immutable—plan for it:**
>
...
- [Palindrome Problems](../.../01-Arrays-Strings/01-Arrays-Strings.md) - More string problems
