...
> **Interview Value:** ⭐⭐⭐⭐⭐ - Word Search is a FAANG favorite  
...
word = "ABCCED" → true
word = "SEE" → true  
word = "ABCB" → false (can't reuse cell)
```
...
From S(1,3):
  → E(2,3): matches 'E' (index 1)
    → E(2,2): matches 'E' (index 2)
...
## 💻 Problem 3: Unique Paths III (Walk Every Empty Cell)
...
- Word length L → maximum L recursive calls
...
- [Graph DFS/BFS](../.../10-Graphs/10-Graphs.md) - Related techniques
