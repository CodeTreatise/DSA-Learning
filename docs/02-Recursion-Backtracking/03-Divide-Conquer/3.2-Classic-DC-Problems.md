...
> **Interview Value:** ⭐⭐⭐⭐⭐ - Direct interview questions  
...
→ Find element at index 5-2 = 3 (0-indexed) after partition
...
When taking 1 from right: 2 elements in left > 1 → count += 2
When taking 3 from right: 1 element in left > 3 → count += 1
...
>
> If subproblems overlap → use Dynamic Programming!
...
- [Sorting topic](../.../03-Sorting-Searching/03-Sorting-Searching.md) - Full sorting coverage
