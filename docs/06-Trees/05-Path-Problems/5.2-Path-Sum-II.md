...
|---------|-----------|-------|
| Amazon | ⭐⭐⭐⭐ | Common follow-up |
| Meta | ⭐⭐⭐⭐ | Tests backtracking |
| Google | ⭐⭐⭐ | May ask optimization |
...
> **💡 Key Insight:** This is the classic tree backtracking problem. The pattern is: add to path → recurse → copy at valid leaf → pop from path. Always remember to copy the path when adding to results, or you'll have a list of empty lists at the end!
